...
export default function RegisterTeam({ setPendingTxns, connectWallet }) {
  ...
  const RegistrationCard = () => (
    <div className="RegisterTeam-card mt-medium section-center">
      {active ? (
        <>
          <RegisterTeamForm chainId={chainId} library={library} account={account} setPendingTxns={setPendingTxns} />
          <div className="mt-medium">
            <div className="create-code-link" onClick={handleCreateCodeClick}>
